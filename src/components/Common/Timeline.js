            ...
            <section className="page-section" id="about">
                <div className="container">
                    <div className="text-center">
                        <h2 className="section-heading text-uppercase">Undertale's Development Roadmap.</h2>
                        <h3 className="section-subheading text-muted">A timeline that briefly explains the development stages of Undertale</h3>
                    </div>
                    <ul className="timeline">
                        <li>
                            ...
                            <div className="timeline-panel">
                                ...
                                <div className="timeline-body"><p className="text-muted">This is a test.</p></div>
                            </div>
                        </li>
